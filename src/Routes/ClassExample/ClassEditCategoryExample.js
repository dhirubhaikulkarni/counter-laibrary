...
function ClassEditCategoryExample() {
    ...
    function createUser(data) {
      ...
      axios.post('http://localhost:8080/api/CategoryDetails/add/' , addData)
      .then((res) => {
        console.log(res);
      });
    }
    ...
    function updateUser(id, data) {
      ...
      axios.post('http://localhost:8080/api/CategoryDetails/edit/' , editData)
      .then((res) => {
        console.log(res);
      });
    }
      ...
      <Container>
        ...
        <Form onSubmit={handleSubmit(onSubmit)} className="AddCategory-popup">
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control name="Category Id" type="text" {...register('categoryid')} />
          </Form.Group>
